export const FLOW_EDITABLE_FIELDS = Object.freeze({
  ...
  followup_reminder_text: { label: "Recordatorio 23h", input: "textarea", maxLength: 4000 },
  offer_promo_text: { label: "Liberación manual", input: "textarea", maxLength: 4000 },
  flash_offer_text: { label: "Oferta relámpago", input: "textarea", maxLength: 4000 },
...
export const CONVERSATION_FLOW = Object.freeze({
  nodes: [
    ...
    { id: "reminder", title: "Recordatorio", subtitle: "Seguimiento automático", description: "A las 23 horas, si no hubo pago, promoción ni revisión humana, envía este audio. Si falla, usa el texto de recordatorio editable.", type: "message", x: 1190, y: 40, fields: ["followup_reminder_text"], media: [
      { type: "audio", label: "Audio de recordatorio 23 h", src: "/media/audios/23horas.mp3" },
    ] },
