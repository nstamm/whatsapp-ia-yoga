export const FLOW_EDITABLE_FIELDS = Object.freeze({
  ...
  reminder2_offer_text: { label: "Oferta directa 23h", input: "textarea", maxLength: 4000 },
  exclusive_offer_text: { label: "Oferta exclusiva de respaldo", input: "textarea", maxLength: 2000, required: true },
...
export const CONVERSATION_FLOW = Object.freeze({
  nodes: [
    ...
    { id: "greeting", title: "Saludo e información", subtitle: "Audio + Fantasía Color PRO", description: "Ante el primer mensaje, envía el audio de bienvenida y presenta una lista visual de beneficios de Fantasía Color PRO con el precio exclusivo por WhatsApp de $16.999. Si el proveedor rechaza el audio, usa el MP3 alternativo y conserva el reintento aunque el proceso se reinicie.", type: "message", x: 590, y: 40, fields: ["initial_offer_text"], media: [
    ...
    { id: "downsell23h", title: "Oferta directa 23h", subtitle: "$9.999 + alias separado", description: "A las 23 horas del mensaje inicial, si el contacto aún no compró, envía directamente la oferta exclusiva de $9.999, presenta al titular y manda el alias sin pedir una confirmación previa. Al recibir y confirmar el pago, envía el link de acceso.", type: "message", x: 1790, y: 40, fields: ["reminder2_offer_text"] },
    { id: "exclusive-offer", title: "Oferta exclusiva", subtitle: "$9.999 + alias separado", description: "Completa cualquier envío pendiente de la oferta de $9.999 sin analizar la respuesta del contacto. Presenta al titular y vuelve a enviar el alias solo para copiarlo fácilmente.", type: "message", x: 2090, y: 40, fields: ["exclusive_offer_text"] },
    { id: "final-discount", title: "Descuento final", subtitle: "$6.999 después de 23h", description: "Si sigue sin comprar, 23 horas después del primer envío de la oferta de $9.999 envía automáticamente una última propuesta a $6.999, aunque el contacto no haya respondido.", type: "message", x: 2390, y: 40, fields: ["final_discount_text"] },
